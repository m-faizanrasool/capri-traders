(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["products-products-module"], {
    ...
    function a1ig(module, __webpack_exports__, __webpack_require__) {
      ...
      var _list_add_product_dialog_add_product_dialog_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./list/add-product-dialog/add-product-dialog.component */
      "0wwu");
      /* harmony import */
      ...
      var _sharedComponents_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    ...
    /***/
    function oKY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _add_product_dialog_add_product_dialog_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      function ListComponent_mat_header_cell_40_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function ListComponent_mat_cell_41_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function ListComponent_mat_header_cell_43_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function ListComponent_mat_cell_44_mat_icon_9_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ListComponent_mat_cell_44_mat_icon_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-icon");
      ...
      function ListComponent_mat_cell_44_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_mat_cell_44_Template_button_click_1_listener() {
            ...
            return ctx_r36.editProduct(product_r32);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_mat_cell_44_Template_button_click_5_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r37);
            ...
            return ctx_r38.deleteProduct(product_r32.id, index_r33);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_mat_cell_44_Template_button_click_8_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r37);
            ...
            return ctx_r39.toggleVisiblity(product_r32);
          });
      ...
      function ListComponent_mat_header_row_45_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-header-row");
        }
      }

      function ListComponent_mat_row_46_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-row");
        }
      }

      function ListComponent_div_47_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ListComponent_div_48_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 37);
      ...
      function ListComponent_mat_spinner_50_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var ListComponent = /*#__PURE__*/function () {
        function ListComponent(productsService, commonService, cdr, dialog) {
          ...
          this.pageSize = 20;
          this.products = [];
          this.displayedColumns = ['name', 'brand', 'quantity', 'purchase_price', 'sale_price', 'discount', 'description', 'image', 'actions'];
        }
        ...
        _createClass(ListComponent, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this.search.valueChanges.subscribe(function () {
              _this2.paginator.pageIndex = 0;
            });
            var filterSubscription = this.paginator.page.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["startWith"])({}), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(this.prepareQueryParams.bind(this))).subscribe(this.handleResponse.bind(this));
          ...
          value: function addProduct() {
            ...
            var dialogRef = this.dialog.open(_add_product_dialog_add_product_dialog_component__WEBPACK_IMPORTED_MODULE_5__["AddProductDialogComponent"], {
              data: {
            ...
            dialogRef.afterClosed().subscribe(function (res) {
              ...
              _this3.productsService.getProducts(_this3.queryParams).subscribe(_this3.handleResponse.bind(_this3));
            });
          }
        }, {
          key: "editProduct",
          value: function editProduct(Product) {
            ...
            dialogRef.afterClosed().subscribe(function (res) {
              ...
              _this4.productsService.getProducts(_this4.queryParams).subscribe(_this4.handleResponse.bind(_this4));
            });
          }
        }, {
          key: "toggleVisiblity",
          value: function toggleVisiblity(product) {
            var _this5 = this;

            product.disabled = true;
            product.is_visible = !product.is_visible;
            this.productsService.toggle_visibility(product.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () {
          ...
          value: function deleteProduct(id, index) {
            ...
            dialogRef.afterClosed().subscribe(function (res) {
              ...
              if (res.confirm) {
                _this6.productsService.deleteProduct(id).subscribe(function (response) {
                  var products = _toConsumableArray(_this6.products);
                  ...
                  _this6.commonService.openSnackBar(response.message);
                }, function (_ref) {
                  var error = _ref.error;

                  _this6.commonService.openSnackBar(error.message, 4000);
                });
              }
            });
          }
